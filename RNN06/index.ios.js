...
const firebaseConfig = {
  ...
  apiKey: "AIzaSyC2jIVgkiBHfiX3n8iFyxCVOEQ2z6pUZP8",
  authDomain: "rnn06-8c980.firebaseapp.com",
  databaseURL: "https://rnn06-8c980.firebaseio.com",
  projectId: "rnn06-8c980",
  storageBucket: "rnn06-8c980.appspot.com",
  messagingSenderId: "883774678070"
};
const firebaseApp = firebase.initializeApp(firebaseConfig);

class RNN06 extends Component {
  ...
  render() {
    return (
          <View style={styles.container}>
            <StatusBar title="LoginProjectV10" />
            <ListView
...
AppRegistry.registerComponent('RNN06', () => RNN06);
