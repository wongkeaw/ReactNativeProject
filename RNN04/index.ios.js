...
// Initialize Firebase
  var firebaseConfig = {
    apiKey: "AIzaSyBwkbQxTccw9xzjhmVld1gfc9Z9eeM9zzU",
    authDomain: "rnn04-ad564.firebaseapp.com",
    databaseURL: "https://rnn04-ad564.firebaseio.com",
    projectId: "rnn04-ad564",
    storageBucket: "rnn04-ad564.appspot.com",
    messagingSenderId: "823730668782"
  };

const firebaseApp = firebase.initializeApp(firebaseConfig);

class RNN04 extends Component {
...
async _setupGoogleSignin() {
  try {
    ...
    await GoogleSignin.configure({
      iosClientId: '823730668782-r298nhpf0ogcus6p6dkt7o2d80e8t51a.apps.googleusercontent.com',
      client_secret: 'd5kppeVEf1__KBsc2zVNRioM',
      webClientId: '823730668782-9cqa2mqgkkd878rt3lbecs75rnvi3nnm.apps.googleusercontent.com',
      offlineAccess: false
    });
...
AppRegistry.registerComponent('RNN04', () => RNN04);
